...
public class MagicFusionRecipes {
  ...
  public static HashMap<String, Integer>[] getRecipe(HashMap<String, Integer> counts) {
    ...
    if (counts.containsKey(Material.GOLD_NUGGET.toString()) && counts.containsKey(Material.REDSTONE.toString())) {
    ...
    } else if(counts.containsKey(Material.OAK_DOOR.toString()) && counts.containsKey(Material.SPRUCE_PLANKS.toString())) {
    ...
    } else if(counts.containsKey(Material.OAK_DOOR.toString()) && counts.containsKey(Material.JUNGLE_PLANKS.toString())) {
      inputs.put(Material.OAK_DOOR.toString(), 1);
      inputs.put(Material.JUNGLE_PLANKS.toString(), 3);
      products.put(Material.JUNGLE_DOOR.toString(), 1);
    } else if(counts.containsKey(Material.OAK_DOOR.toString()) && counts.containsKey(Material.BIRCH_PLANKS.toString())) {
      inputs.put(Material.OAK_DOOR.toString(), 1);
      inputs.put(Material.BIRCH_PLANKS.toString(), 3);
      products.put(Material.BIRCH_DOOR.toString(), 1);
    } else if(counts.containsKey(Material.OAK_DOOR.toString()) && counts.containsKey(Material.DARK_OAK_PLANKS.toString())) {
      inputs.put(Material.OAK_DOOR.toString(), 1);
      inputs.put(Material.DARK_OAK_PLANKS.toString(), 3);
      products.put(Material.DARK_OAK_DOOR.toString(), 1);
    } else if(counts.containsKey(Material.OAK_DOOR.toString()) && counts.containsKey(Material.ACACIA_PLANKS.toString())) {
      inputs.put(Material.OAK_DOOR.toString(), 1);
      inputs.put(Material.ACACIA_PLANKS.toString(), 3);
      products.put(Material.ACACIA_DOOR.toString(), 1);
    } else if(counts.containsKey("craftory:belt") && counts.containsKey(Material.REDSTONE.toString())) {
