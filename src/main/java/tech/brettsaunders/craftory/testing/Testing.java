...
public class Testing {
  ...
  public static void placeGrid(Location baseLocation, String mainMachineName, String generatorName,
    ...
    for (int i = 0; i < width; i++) {
      placeColumn(location, mainMachineName, generatorName, energyCellName, insertItemName,
          fuelName, length);
      location.add(0, 0, 5);
    }
  }

  public static void placeColumn(Location baseLocation, String mainMachineName,
      String generatorName, String energyCellName, String insertItemName, String fuelName,
      int length) {
    Location location = baseLocation.clone();
    for (int i = 0; i < length; i++) {
      placeModule(location, mainMachineName, generatorName, energyCellName, insertItemName,
          fuelName);
      location.add(2, 0, 0);
    }
  }

  private static void placeModule(Location baseLocation, String mainMachineName,
      String generatorName, String energyCellName, String insertItemName, String fuelName) {
    ...
    BaseProvider energyCellBlock = (BaseProvider) placeBlock(energyCellName,
