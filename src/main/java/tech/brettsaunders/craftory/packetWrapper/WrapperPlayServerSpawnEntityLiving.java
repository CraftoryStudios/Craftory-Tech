 ...
 *
 * Edited by Matthew Jones and Brett Saunders
 */
...
public class WrapperPlayServerSpawnEntityLiving extends AbstractPacket {
   ...
   */
  public UpdatedEntityType getType() {
    return UpdatedEntityType.fromID(handle.getIntegers().read(1));
  }
  ...
  public void setType(UpdatedEntityType type) {
    handle.getIntegers().write(1, type.getId());
  }
