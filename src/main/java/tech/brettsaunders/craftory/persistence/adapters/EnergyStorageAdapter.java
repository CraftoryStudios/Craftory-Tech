...
public class EnergyStorageAdapter implements DataAdapter<EnergyStorage> {
  ...
  @Override
  public void store(PersistenceStorage persistenceStorage, EnergyStorage value,
  ...
  public EnergyStorage parse(PersistenceStorage persistenceStorage, Object parentObject,
      NBTCompound nbtCompound) {
    return new EnergyStorage(nbtCompound.getInteger("energy"), nbtCompound.getInteger("capacity"),
